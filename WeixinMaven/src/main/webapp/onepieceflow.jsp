	...
	wx.error(function (res) {
		...
		$(document).ready(function(){ 
			if(<%=isExist%>) {
				//alert(1);
				$.ajax({
				      url: "actionServlet?action=onepieceflow",
				      datatype: "json",
				      type: "post",
				      data: {},
		...
		function addInfo(index, item) {
			$("#info").append(
                    ...
                    "<td><a href=\"onepieceflow_detail.jsp?openId=<%=openId%>&produceM_BillNo=" + item.produceM_BillNo + "\">查看详情</a></td>" +
                    "</tr>");
		}
...
<div class="panel panel-success">
    <div class="panel-heading" style="background-color:#034690;">
        <h3 class="panel-title" style="color:#fff;">单件流报表</h3>
    </div>
