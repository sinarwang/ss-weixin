...
<%
	String produceM_Name = request.getParameter("produceM_Name");
%>
...
<html lang="zh-CN">
	<head>
		...
		<title>生产台账相关查询（<%=produceM_Name %>）</title>
		...
		wx.error(function (res) {
			...
			$(document).ready(function(){ 
				if(<%=isExist%>) {
					//alert(1);
					$.ajax({
					      url: "actionServlet?action=vpr_produceM_detail&produceM_Name=<%=produceM_Name%>",
					      datatype: "json",
					      type: "post",
					      data: {},
	...
	<body>
		<div class="panel panel-success">
		    <div class="panel-heading" style="background-color:#034690;">
		        <h3 class="panel-title" style="color:#fff;">生产台账报表</h3>
		    </div>
		...
		<div style="float:left;width:99%;margin-left:0.5%;"><a href="goodUserChart.jsp?openId=<%=openId %>" class="btn btn-primary btn-block">优秀员工统计表</a></div>
	</body>
</html>