	...
	<body>
		...
		$(document).ready(function(){ 
			...
			if(<%=isExist%>) {
				//alert(1);
				$.ajax({
				      url: "actionServlet?action=workflowCompleteChart",
				      datatype: "json",
				      type: "post",
				      data: {},
		...
		<div style="width:100%;">
		    <div style="width:380px;height:114px;margin:20px auto;line-height:15px;"><img src="images/chengpin.png"><br>
