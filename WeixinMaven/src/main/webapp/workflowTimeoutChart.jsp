...
<html lang="zh-CN">
	...
	<body>
		...
		$(document).ready(function(){ 
			...
			//总框数数据数组
			var cardNosArray = new Array();
			
			if(<%=isExist%>) {
				//alert(1);
				$.ajax({
				      url: "actionServlet?action=workflowTimeoutChart",
				      datatype: "json",
				      type: "post",
				      data: {},
		...
		<div style="width:100%;">
		    <div style="width:380px;height:114px;margin:20px auto;line-height:15px;"><img src="images/chaopaicheng.png"><br>
		        ...
		        <div style="width:120px;height:25px;float:left;margin-top:10px;font-size:30px">
		            <div style="width:20px;height:15px;background:#a9ff96;float:left;margin-right:5px;"></div>框数
		        </div>
		    </div>
		</div>
