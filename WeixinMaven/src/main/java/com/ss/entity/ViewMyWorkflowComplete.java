...
/**
 * ViewMyWorkflowCompleteId entity. @author MyEclipse Persistence Tools
 */

public class ViewMyWorkflowComplete implements java.io.Serializable {
	...
	/** default constructor */
	public ViewMyWorkflowComplete() {
	}

	public String getNameInDB() {
		return "view_my_workflow_complete";
	}
	
	// Property accessors
	
	public void initFromRs(ResultSet rs) {
		Field[] fields = ViewMyWorkflowComplete.class.getDeclaredFields();
		try {
			for(Field f : fields) {
				String fieldName = f.getName().substring(0, 1).toUpperCase() + f.getName().substring(1);
				String methodName = "set" + fieldName;
				Class fieldType = f.getType();
				Method m = ViewMyWorkflowComplete.class.getDeclaredMethod(methodName, fieldType);
	...
	public Integer getD_Rate() {
		return D_Rate;
	}
	public void setD_Rate(Integer d_Rate) {
		D_Rate = d_Rate;
	}
