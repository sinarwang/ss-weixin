	...
	wx.error(function (res) {
		...
		$(document).ready(function(){ 
			if(<%=isExist%>) {
				//alert(1);
				$.ajax({
				      url: "actionServlet?action=chkPackage",
				      datatype: "json",
				      type: "post",
				      data: {},
		...
		function addInfo(index, item) {
            ...
            if(item.d_Weight == 0) {
	  	    ...
	  	    str = str +  "<td>" + item.d_StartTime + "</td>" + 
...
<div class="panel panel-success">
    <div class="panel-heading" style="background-color:#034690;">
        <h3 class="panel-title" style="color:#fff;">打包报表</h3>
    </div>
        ...
        <div class="table-responsive" >
            ...
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">打包号</th>
                    <th style="text-align:center">合同项次号</th>
...
<div style="float:left;width:99%;margin-left:0.5%;margin-bottom:20px;"><a href="chkPackageChart.jsp?openId=<%=openId %>" class="btn btn-primary btn-block">本月打包数据统计</a></div>
</body>
</html>