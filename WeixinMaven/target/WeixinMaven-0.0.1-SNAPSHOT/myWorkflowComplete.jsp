	...
	wx.error(function (res) {
		...
		$(document).ready(function(){ 
			if(<%=isExist%>) {
				//alert(1);
				$.ajax({
				      url: "actionServlet?action=workflowComplete",
				      datatype: "json",
				      type: "post",
				      data: {},
		...
		function addInfo(index, item) {
			...
			if(item.produceM_Weights == 0) {
				str = str + "<td></td>";
			} else {
				str = str + "<td>" + item.produceM_Weights + "</td>";
			}
			str = str +  "<td>" + item.feedingDate + "</td>" + 
...
<div class="panel panel-success">
    <div class="panel-heading" style="background-color:#034690;">
        <h3 class="panel-title" style="color:#fff;">成品报表</h3>
    </div>
        ...
        <div class="table-responsive" >
            ...
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">是否转质检</th>
                    <th style="text-align:center">工序完成时间</th>
                    <th style="text-align:center">工序支数</th>
                    <th style="text-align:center">工序重量</th>
                    <th style="text-align:center">工序米数</th>
...
<div style="float:left;width:99%;margin-left:0.5%;margin-bottom:20px;"><a href="workflowCompleteChart.jsp?openId=<%=openId %>" class="btn btn-primary btn-block">本月成品数据统计</a></div>
</body>
</html>