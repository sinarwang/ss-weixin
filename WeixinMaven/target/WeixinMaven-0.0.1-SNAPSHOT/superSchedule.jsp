...
<html lang="zh-CN">
		...
		wx.error(function (res) {
			...
			$(document).ready(function(){ 
				if(<%=isExist%>) {
					//alert(1);
					$.ajax({
					      url: "actionServlet?action=superSchedule",
					      datatype: "json",
					      type: "post",
					      data: {},
	...
	<body>
		<div class="panel panel-success">
		    <div class="panel-heading" style="background-color:#034690;">
		        <h3 class="panel-title" style="color:#fff;">订单超排程报表</h3>
		    </div>
		        ...
		        <div class="table-responsive" >
		            ...
		            <thead>
		                <tr>
		                    ...
		                    <th style="text-align:center">当前规格</th>
		                    <th style="text-align:center">超期(天数)</th>
		                </tr>
		            </thead>
		            <tbody id="info">
		            	<tr id="loading">
	...
	<div style="float:left;width:99%;margin-left:0.5%;margin-bottom:20px;"><a href="workflowTimeoutChart.jsp?openId=<%=openId %>" class="btn btn-primary btn-block">超排程统计表</a></div>
	</body>
</html>