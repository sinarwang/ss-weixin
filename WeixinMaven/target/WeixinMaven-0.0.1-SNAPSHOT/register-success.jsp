...
<div class="middle-box text-center animated fadeInDown" style="margin-top:80px;">
    <div>
        <div>
            <div class="logo-name"><img src="images/success.png"></div>
        </div>
        <h4 style="margin-top:25px;font-weight:bold;font-family:"微软雅黑";">恭喜！注册成功！</h4>
        <h4 style="margin-top:10px;font-weight:bold;font-family:"微软雅黑";">感谢对上上钢管的支持！</h4>
