                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="loginServlet?action=quit">安全退出</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="boot.html">首页</a>
                    </div>
                </nav>
                ...
                <a href="loginServlet?action=quit" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="guanli.jsp?v=4.0" frameborder="0" data-id="boot.html" seamless></iframe>
            </div>
            <div class="footer">
